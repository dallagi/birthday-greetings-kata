...
public class BirthdayServiceTest {
    ...
    public void should_send_message() throws Exception {
        ...
        birthdayService.sendGreetings(new XDate(BIRTHDAY_DATE), employeesRepository, sender);
    ...
    public void should_not_send_message() throws Exception {
        ...
        birthdayService.sendGreetings(new XDate(ANOTHER_DATE), employeesRepository, sender);
